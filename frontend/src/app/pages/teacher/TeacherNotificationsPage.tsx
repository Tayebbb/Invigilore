...
export default function TeacherNotificationsPage() {
  ...
  function handleNavChange(label: string) {
    ...
    else if (label === 'Create Exam') navigate('/teacher/exams/new');
    else if (label === 'Student Results') navigate('/teacher/results');
    else if (label === 'Notifications') navigate('/teacher/notifications');
  }
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-400 ml-12">Exam events, role assignments, and system alerts.</p>
          </div>
